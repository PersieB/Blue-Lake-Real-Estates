...
/*
Program provides page to view all properties
*/
...
if($_SESSION["username"]){
    ...
    <body id="page-top">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <a class="nav-link" href="UsergeneralView.php" style="color:rgb(226, 101, 101);" >Properties</a>
        ...
        while ($row = mysqli_fetch_array($result)) {
            echo "<div class='card' style='width: 70%; margin: auto; border: 2px solid black;'>";
            echo "<img style='height: 600px; width: 100%;'src='apartments/".$row['MyImage']."' >";
                echo "<div class='container' style='padding: 2px 16px; background-color: white;'>";
                    ...
                    echo "<p>Price: GHC ";
                    echo $row['MyPrice']. " </p>";
                    echo "<p class='text-muted'> Posted: ";
        ...
        for($b = 1; $b <=$per_page; $b++){
            ...
            style='font-size: 30px;color: black;'href="UsergeneralView.php?page=<?php echo $b; ?>"> <?php echo "&laquo; ". $b." &raquo; ";?></a> <?php
        }
        echo "</div>";
        mysqli_close($db);
    ?>
